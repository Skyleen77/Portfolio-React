...
export default function Board() {
    ...
    useEffect(() => {
        const generateBoard = () => {
        const getBoard = createBoard(13, 10, 20, setMineLocations);
        setNonMinesCount(13 * 10 - 20);
        setTime(0);
    ...
    return (
        ...
        <TopBar gameOver={gameOver} setTime={setTime} newTime={newTime} mineCounter={nonMinesCount} />
